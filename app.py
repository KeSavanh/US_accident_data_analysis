...
# ------------------------------------------------------------------------------------------------------------
# creating routes for jsonify data for different plots
# -------------------------------------------------------------------------------------------------------------
...
def formulateResponse(accidentList, type):
    ...
    return response
# -----------------------------------------------------------------------------------------------------------------------
# creating routes for webpages for showing plots
# -------------------------------------------------------------------------------------------------------------------------
...
# ------------------------------------------------------------------------------------------------------------------------
# route for showing city wise accidents counts plot yearly and monthly


@app.route("/city-datavis")
def cityvis():
    return render_template('city.html')
# -----------------------------------------------------------------------------------------------------------------------
# route for showing city wise accidents counts plot weekly and hourly


@app.route("/time-datavis")
def timevis():
    return render_template('time.html')
# ------------------------------------------------------------------------------------------------------------------------
# route for showing weather plots


@app.route("/weather-datavis")
def weathervis():
    return render_template('weather.html')
# ------------------------------------------------------------------------------------------------------------------------
# route for showing severity and roadcondition wise accidents counts
