...
d3.json("/roadcondition/data").then(function (data) {
    ...
    // Render the plot to the div tag with id "plot"
    Plotly.newPlot("plot3", traceData, layout1);
}); 
...
d3.json("/prcp-wsp/data").then(function (data) {
    ...
    // Render the plot to the div tag with id "plot"
    Plotly.newPlot("plot5", traceData, layout2);
    Plotly.newPlot("plot6", traceprcp, layout1);
});


/////////////////////////////////////////////////////////////////
//CITY VS ACCIDENT COUNT //
...
d3.json("/city/data").then(data => {
    ...
    // Render the plot to the div tag with id "plot"
    Plotly.newPlot("plot11", traceData, layout1);
});
